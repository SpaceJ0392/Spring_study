...
import spring_and_jpa_api_study.springboot_and_jpa2.domain.*;
import spring_and_jpa_api_study.springboot_and_jpa2.domain.item.Book;
...
public class InitDb {
    ...
    static class InitService{
        ...
        private Member createMember(String name, String city,String street, int zipcode) {
